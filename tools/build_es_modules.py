...
def main() -> None:
    ...
    (JS / "main.js").write_text(
        ...
        f"import './core/department-note-schema.js?v={BUILD_VERSION}';\n"
        f"import './core/department-note-utils.js?v={BUILD_VERSION}';\n"
        f"import './core/department-note-store.js?v={BUILD_VERSION}';\n"
        f"import './core/department-note-badge.js?v={BUILD_VERSION}';\n"
        f"import './core/department-note-department-renderer.js?v={BUILD_VERSION}';\n"
        f"import './core/department-note-reply.js?v={BUILD_VERSION}';\n"
        f"import './core/department-note-pharmacy-renderer.js?v={BUILD_VERSION}';\n"
        f"import './core/expiry-settings.js?v={BUILD_VERSION}';\n"
        f"import './core/order-retention.js?v={BUILD_VERSION}';\n"
        f"import './core/print-page-state.js?v={BUILD_VERSION}';\n"
        f"import './core/excel-loader.js?v={BUILD_VERSION}';\n"
        f"import './core/category-options.js?v={BUILD_VERSION}';\n"
        f"import './core/request-schedule-store.js?v={BUILD_VERSION}';\n"
        f"import './core/schedule-utils.js?v={BUILD_VERSION}';\n"
        f"import './core/schedule-limits.js?v={BUILD_VERSION}';\n"
        f"import './core/schedule-department-options.js?v={BUILD_VERSION}';\n"
        f"import './core/schedule-renderers.js?v={BUILD_VERSION}';\n"
        f"import './core/next-dispense-slot.js?v={BUILD_VERSION}';\n"
        f"import './core/schedule-form-utils.js?v={BUILD_VERSION}';\n" + imports + "\n"
