...
function openAddExpiry(){
  ...
  globalThis.el('exp-batch-inp').value='';globalThis.el('exp-date-inp').value='';globalThis.el('exp-qty-inp').value='';globalThis.el('exp-edit-id').value='';globalThis.OM('mexpiry');
}
function openEditExpiry(button){
  ...
  globalThis.el('exp-batch-inp').value=button.dataset.batch||'';globalThis.el('exp-date-inp').value=button.dataset.date||'';globalThis.el('exp-qty-inp').value=button.dataset.qty==null?'':button.dataset.qty;globalThis.el('exp-edit-id').value=button.dataset.bid||'';globalThis.OM('mexpiry');
}
