...
function setupAnnualReport(){
  // Reports have one canonical home: Analytics.  This guard also removes the
  // legacy card from pages opened from an older cached index.html.
  var card=E('annual-analytics-print-card');
