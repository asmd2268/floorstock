...
(function(){
  ...
  window.addDispSlot=function(){q('mdisp-title').textContent='Add Dispense Slot';q('dslot-label').value='';q('dslot-from').value='10:00';q('dslot-to').value='11:00';q('dslot-notes').value='';q('dslot-edit-id').value='';if(typeof globalThis.setScheduleDeptMulti==='function')globalThis.setScheduleDeptMulti('all');globalThis.setScheduleDays(q('dslot-days'),[0,1,2,3,4]);globalThis.OM('mdisp-slot')};
  window.editDispSlot=function(i){var s=globalThis.getDispSlots()[i];if(!s)return;q('mdisp-title').textContent='Edit Dispense Slot';q('dslot-label').value=s.label||'';q('dslot-from').value=s.from||s.time||'';q('dslot-to').value=s.to||'';q('dslot-notes').value=s.notes||'';q('dslot-edit-id').value=i;if(typeof globalThis.setScheduleDeptMulti==='function')globalThis.setScheduleDeptMulti(s.dept||'all');globalThis.setScheduleDays(q('dslot-days'),s.days||[]);globalThis.OM('mdisp-slot')};
})();
