import { normalizeRole, resolvePermissionProfile, canWriteStateKey, canDeleteStateKey } from '../core/role-capabilities.js?v=95e63d4c90';
(function(){
'use strict';
...
var ALLOWED=new Set((
  ...
  'crashPrint crashAddItem crashReportOpen ccxOpenReport ccCrashExpiryChoiceChanged ccCrashUnavailableToggled ccCrashResponsePreview v13asViewReport setCrashSealPolicy ccAcceptReport ccRejectReport ccToggleNoConsumption ccSaveNCSettings ccExtraBatchChoiceChanged ccApplyExtraBatches '+
  'r17CrashSaveDetails r18OpenCrashCorrection r18CrashCorrectionAddBatch r17CrashRenderMatrix '+
  'acc2SetAdminTab acc2RefreshMedicationList acc2SaveAssignment acc2CancelAssignmentEdit acc2EditAssignment acc2ToggleAssignment acc2DeleteAssignment acc2SetFilter acc2Decision acc2UndoApproval acc2SaveGrace mrSetPeriod mrSetSearch acc2SubSetDays acc2SubSetMed acc2SetReceiptDept acc2RegimenDeptChanged acc2SaveRegimenVersion acc2CancelRegimenEdit acc2ActivateRegimen acc2ToggleRegimenPause acc2StartRegimenVersion acc2DeleteRegimen acc2SubmitUsage '+
  ...
  'acc2AddExpiryRow acc2RemoveExpiryRow acc2SaveExpiryBatches acc2MedSearch '+
