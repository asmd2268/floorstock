...
function fsR5OrdersHtml(orders){
  ...
  var runtimeUrl='';
  try{runtimeUrl=new URL('./assets/js/print-orders-runtime.js?v=R6.74.0',window.location.href).href;}catch(e){runtimeUrl='/assets/js/print-orders-runtime.js?v=R6.74.0';}
