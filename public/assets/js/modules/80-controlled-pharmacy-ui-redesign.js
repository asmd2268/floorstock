...
(function(){
  ...
  function ccResponseRowPlan(row){
    ...
    return {itemId:row.dataset.id,reportedQty:reportedQty,removeQty:reportedQty,unavailable:unavailable,action:unavailable?'add':'replace',sourceExpiry:unavailable?'':ccDateKey(row.dataset.reportedExpiry||''),qty:qty,expiry:expiry}
  }
