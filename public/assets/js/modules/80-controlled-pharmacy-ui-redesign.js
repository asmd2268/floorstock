...
(function(){
  ...
  window.crashCloseReport=function(reportId){
    ...
    var belowRows=belowStd.map(function(it){return ccNonReportedRow(it,'⬇ Below standard / أقل من المعياري','rgba(200,100,20,.06)');}).join('');
    var otherRows=atStd.map(function(it){return ccNonReportedRow(it,'✓ At standard / عند المستوى','rgba(80,95,115,.06)','other');}).join('');
