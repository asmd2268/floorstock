...
function acc2Bar(pct,color){return '<div style="height:10px;background:var(--br,#e2e8f0);border-radius:10px;overflow:hidden;margin-top:4px"><div style="height:100%;width:'+Math.max(2,Math.round(pct))+'%;background:'+color+';border-radius:10px;transition:width .4s"></div></div>'}
function acc2AnalyticsTab(){
