...
function acc2PendingUnits(assignmentId){return acc2Usage().filter(function(u){return String(u.assignmentId)===String(assignmentId)&&u.status==='pending_pharmacy'}).reduce(function(s,u){return s+acc2Number(u.units)},0);}
function acc2EffectiveBalance(a){return Math.max(0,acc2Number(a.balance)-acc2PendingUnits(a.id));}
