...
window.ccxRenderDashboardAlerts=function(){
  ...
  var rows=allActive.map(function(r){
    ...
    var btn=(isPending||r.status==='open')&&isPharmacy()
      ?'<button class="btn bs bsm" data-clickact="showPg" data-a1="pg-crashcart\');ccxOpenReport(\''+escx(r.id)+'">↻ Respond / الرد</button>'
      :(isPending||r.status==='open')?''
      :'<span class="btn bd2c bsm" data-clickact="showPg" data-a1="pg-crashcart\');ccxOpenReport(\''+escx(r.id)+'">Open</span>';
