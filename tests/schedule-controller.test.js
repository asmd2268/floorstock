...
test('schedule controller owns all CRUD actions', () => { for (const action of ['saveReqWindow','toggleWindow','delWindow','saveDispSlot','delSlot','saveAllLimits','saveBulkLimits']) assert.match(controller, new RegExp('window\\.'+action+'=')); });
